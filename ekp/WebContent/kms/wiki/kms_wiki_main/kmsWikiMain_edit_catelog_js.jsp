...
<script type="text/javascript">
	...
	function selectEditors(thisObj) {
		var obj = thisObj.parentNode, idObj = obj.childNodes[0], nameObj = (obj.childNodes[1].nextElementSibling) ? obj.childNodes[1].nextElementSibling
				: obj.childNodes[1].nextSibling;
