...
<tr>
		<td class="td_normal_title" width=20%>
			<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.fdTimeUnit"/>
		</td><td width=80%>
			...
			<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.fdTimeUnit.month"/>
			...
			<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.fdTimeUnit.year"/>
		</td>
</tr>
<tr>
	<td class="td_normal_title" width=20%>
			<bean:message bundle="kms-evaluate" key="kmsEvaluateCommon.fdCountTime"/>
	</td>
	<td width=80% id="month">	
			<input type='hidden' name='monthPeriodType' value='1'/>
			<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.fdTimeUnit.timeStart"/>
			<kmss:period property="monthStartTime" periodTypeName="monthPeriodType"/>
			<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.fdTimeUnit.timeEnd"/>
...
function submited(){
	...
	if(bgtime>endtime){
		alert('<bean:message  bundle="kms-evaluate" key="kmsEvaluateCommon.timeError"/>');
		return false;
	}
	return true;
}
