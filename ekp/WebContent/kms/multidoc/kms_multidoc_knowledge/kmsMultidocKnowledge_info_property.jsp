...
$(function() {
	...
	~~function() {
		$('#ok').bind('click', function() {
			jQuery.ajax({
			//	url: KMS.basePath + '/multidoc/kms_multidoc_knowledge/kmsMultidocKnowledge.do?method=updateProperty',
				url: KMS.basePath + updateUrl ,
				type: 'POST',
				dataType: 'json',
				data: $(document.getElementsByName('kmsMultidocKnowledgeForm')[0]).serialize(),
...
var updateUrl = "/multidoc/kms_multidoc_knowledge/kmsMultidocKnowledge.do?method=updateProperty&fdId=${param.fdId}";
$(function() {
	var templateId= "${param.templateId}";
	if(templateId != "" || templateId!= null) {
		//templateId是做视图页面下的批量属性修改的权限判断用的
	    updateUrl = "/multidoc/kms_multidoc_knowledge/kmsMultidocKnowledge.do?method=updateProperty&templateId=${param.templateId}"
	}
})
