...
<ui:ajaxtext>
	<script>
		seajs.use("kms/multidoc/kms_multidoc_portlet_ui/style/portlet.css");
	</script>
	<ui:dataview>
		<ui:render type="Template">
			...
			{$
				<dl class="lui_multidoc_preview_dl_a"> 
					<dt>
						<a target="_blank" href="${LUI_ContextPath}/kms/multidoc/?categoryId={% data[i].id %}" 
					...
					for (var j = 0, ln = data[i].children.length; j<ln; j++) {
						{$
							<a target="_blank" href="${LUI_ContextPath}/kms/multidoc/?categoryId={%data[i].children[j].id%}" 
