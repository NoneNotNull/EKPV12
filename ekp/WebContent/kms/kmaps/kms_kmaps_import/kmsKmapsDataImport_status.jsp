...
function refreshInfo(){
	...
	data.UseCache = false;
	data.AddBeanData("kmsKmapsDataImportXMLDataBean");
...
function doAction(method){
	location.href = "<c:url value="/sys/datainit/sys_datainit_main/sysDatainitMain.do?method="/>"+method+"&type=${param.type}";
}
