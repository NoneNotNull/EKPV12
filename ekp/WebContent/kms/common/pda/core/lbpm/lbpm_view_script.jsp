...
<script>
Com_Parameter.JsFileList[Com_Parameter.JsFileList.length] = 'js/jquery.js';
</script>
...
<script src="<c:url value="/kms/common/pda/core/lbpm/script/lbpmProcess.js"/>"></script>
<script src="<c:url value="/sys/lbpmservice/resource/address_builder.js"/>"></script>
...
<script type="text/javascript">	
	Com_Parameter.JsFileList[Com_Parameter.JsFileList.length] = 'jquery.js';
	$(function() {
		Com_Parameter.event["submit"][Com_Parameter.event["submit"].length] = function() {
			var auditNodeObj = lbpm.operations.getfdUsageContent();
			if(auditNodeObj) {
				auditNodeObj.value  = auditNodeObj.value + ' <kmss:message bundle="sys-lbpmservice" key="lbpm.process.pda.log.from"/>';
