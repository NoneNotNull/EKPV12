...
<p class="txttitle"><bean:message bundle="kms-common" key="kmsCommonDocErrorCorrectionFlow.info"/></p>

<center>
<table id="Label_Tabel" width=95%>
<tr LKS_LabelName="<bean:message bundle='kms-common'  key='kmsCommonDocErrorCorrectionFlow.info' />">
<td>
