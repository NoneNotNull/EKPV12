...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div data-dojo-type="mui/header/HeaderItem" 
		...
		data-dojo-props="href:'/example/rules/example_rules_main/mobile/index.jsp'">
	</div>
	<div data-dojo-type="mui/header/HeaderItem" 
...
<div id="scroll" data-dojo-type="mui/list/StoreScrollableView">
	<div
		...
		data-dojo-props="modelName:'com.landray.kmss.example.rules.model.ExampleRulesMain',needPrompt:false,height:'3.8rem'">
	</div>
