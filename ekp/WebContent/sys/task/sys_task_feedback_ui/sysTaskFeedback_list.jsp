	...
	<template:replace name="body">
		<list:listview >
			<ui:source type="AjaxJson">
				{"url":"/sys/task/sys_task_feedback/sysTaskFeedback.do?method=list&fdTaskId=${param.fdTaskId}&rowsize=10"}
			</ui:source>
			<%--列表形式--%>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable" cfg-norecodeLayout="simple"
				...
				<list:col-auto props="docCreator.fdName;docCreateTime;sysTaskMain.docSubject;fdProgress"></list:col-auto>
				<list:col-html   title="${ lfn:message('sys-task:sysTaskFeedback.docContent') }">
					{$<span class="content">
					{%row.docContent%}
					</span>$}
				</list:col-html>
