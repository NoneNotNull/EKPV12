				...
				<div id="dateView" data-dojo-type="dojox/mobile/View">
					...
					<div class="muiTaskDatetimeContainer">
						<div class="muiTaskDatetime">	
							<xform:datetime property="fdPlanCompleteDate" dateTimeType="date" mobile="true" required="true" htmlElementProperties="id='fdPlanCompleteDate'"></xform:datetime>
						</div>
						<div class="muiTaskWeek"></div>
						<div class="muiTaskDatetime">	
							<xform:datetime property="fdPlanCompleteTime" dateTimeType="time" mobile="true" required="true" htmlElementProperties="id='fdPlanCompleteTime'"></xform:datetime>
						</div>
					</div>
				</div>
				...
				<div id="personView" data-dojo-type="dojox/mobile/View">
					<ul class="muiSettingPeopleList">
						...
						<li>
							...
							<xform:address propertyId="fdPerformId" propertyName="fdPerformName" style="width:80%" subject="${lfn:message('sys-task:sysTaskMainPerform.fdPerformId') }"
						...
						<li>
							...
							<xform:address propertyId="fdAppointId" propertyName="fdAppointName" style="width:80%"
								orgType='ORG_TYPE_PERSON' mobile="true"></xform:address>
						</li>
						<%--抄送人--%>
						<li>
							<bean:message bundle="sys-task" key="sysTaskMainCc.fdCcId" />
							<xform:address propertyId="fdCcIds" propertyName="fdCcNames" style="width:80%"
...
require(['dojo/ready','dojo/date/locale','dojo/date','dojo/query','dojo/topic','dijit/registry','mui/dialog/Tip'],
		function(ready,locale,dateClz,query,topic,registry,Tip){
	//校验对象
	var validorObj=null;
