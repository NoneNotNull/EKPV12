...
<body>
<table cellpadding=0 cellspacing=0 width="100%" style="height:100%; border-collapse:collapse;border: 0px #303030 solid;">
	<tr>
		<td valign="top" style="width:180px; border:#303030 solid; border-width:0px 1px 0px 0px; border-collapse:collapse;">
			<iframe height=100% style="width:180px;" frameborder=0 scrolling="auto" src='dialog_tree.jsp'></iframe>
		</td>
		<td width="10px">&nbsp;</td>
		<td valign="center">
