...
<script language="JavaScript">
	...
	( function(operations) {
		...
		function OperationClick(operationName){
			...
			var html = '<select name="jumpToNodeIdSelectObj" alertText="" key="jumpToNodeId" style="max-width:200px;"></select>';
			if (window.dojo) {
				html += "<div class='refusePassedToThisNode'>";
			}
			html += '<label style="margin-left: 8px;"><input type="checkbox" id="refusePassedToThisNode" value="true" alertText="" key="refusePassedToThisNode"';
