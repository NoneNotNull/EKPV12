...
<div id="optBarDiv">
	<kmss:auth requestURL="/sys/lbpmservice/support/lbpm_operations/lbpmOperations.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			...
			onclick="Com_OpenWindow('lbpmOperations.do?method=edit&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/sys/lbpmservice/support/lbpm_operations/lbpmOperations.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			...
			onclick="if(!confirmDelete())return;Com_OpenWindow('lbpmOperations.do?method=delete&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<input type="button"
