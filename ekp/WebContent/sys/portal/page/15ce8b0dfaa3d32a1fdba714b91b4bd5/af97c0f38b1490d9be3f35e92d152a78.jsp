       ...
       <tbody> 
        <tr> 
         ...
         <td width="354" valign="top" data-lui-type="lui/portal!Container"><script type="text/config">{"columnProportion":"1","columnWidth":"354","hSpacing":"15","vSpacing":"15","columnStyle":"","columnLock":false}</script>  
          <ui:panel toggle="false" layout="sys.ui.panel.default" height="240" scroll="false" id="p_77601843a27be6b42151">
           <portal:portlet title="最新工作案例">
            <ui:dataview format="sys.ui.classic">
             <ui:source ref="work.cases.source"></ui:source>
            ...
            <ui:operation href="/work/cases/?categoryId=!{cateid}" name="{operation.more}" type="more" align="right"></ui:operation>
            <ui:operation href="javascript:(function(){seajs.use(['work/cases/work_cases_main/js/create'], function(create) {         create.addDoc(\'!{cateid}\');       });})();" name="{operation.create}" target="_self" type="create" align="right"></ui:operation>
           </portal:portlet>
          </ui:panel>  </td> 
        </tr> 
       </tbody> 
