...
function createHeader(){
	...
	$('<div class="lui_calendar_header_month" cal-opt="month">月</div>').appendTo(rightTd).click(function(){
		calendar.changeView('month');
	});
	
	$('<div class="lui_calendar_header_month" cal-opt="agendaWeek">周</div>').appendTo(rightTd).click(function(){
		calendar.changeView('agendaWeek');
	});
	
	$('<div class="lui_calendar_header_date" cal-mode="default"/>').appendTo(rightTd).click(function(){
		calendar.changeMode('default');
	});
	
	$('<div class="lui_calendar_header_list" cal-mode="list"/>').appendTo(rightTd).click(function(){
