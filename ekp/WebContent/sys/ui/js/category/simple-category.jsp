		...
		seajs
				.use(
						...
						function(category, $, topic) {
							var url = '/sys/simplecategory/criteria/sysSimpleCategoryCriteria.do?method=select&modelName=${param.modelName}&parentId=!{parentId}&searchText=!{searchText}&currId=!{currId}&type=!{type}&authType=${param.authType}&pAdmin=!{pAdmin}';
