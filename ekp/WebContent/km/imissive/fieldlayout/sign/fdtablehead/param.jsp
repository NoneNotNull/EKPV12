...
<form>
	<table class="tb_normal"  width=95%>
	  ...
	  <tr>
			<td class="td_normal_title" width=25%>${lfn:message('km-imissive:kmMissiveSignTemplate.fdTableHead')}</td>
			<td>
			    <xform:textarea property="fdTableHead" 
			                    ...
			                    subject="${lfn:message('km-imissive:kmMissiveSignTemplate.fdTableHead')}">
			    </xform:textarea>
			</td>
	  </tr>
