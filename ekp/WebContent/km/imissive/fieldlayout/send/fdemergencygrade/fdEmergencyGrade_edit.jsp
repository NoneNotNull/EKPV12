...
%>
    <xform:select property="fdEmergencyGradeId" subject="${lfn:message('km-imissive:kmImissiveSendMain.fdEmergencyGrade')}" showStatus="edit" required="<%=required%>" style="<%=parse.getStyle()%>" value="<%=defaultValue%>">
