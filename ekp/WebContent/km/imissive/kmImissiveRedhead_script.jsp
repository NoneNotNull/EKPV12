...
function LoadHeadWordList(fdModelName){
	var url =Dialog_SimpleCategoryForNewFile("com.landray.kmss.km.imissive.model.KmImissiveRedHeadTemplate","createUrl?&fdTemplateId=!{id}&fdTemplateName=!{name}",false,true,"02",null,true,"<bean:message bundle='km-imissive' key='kmImissiveRedheadset.select'/>");
