			...
			<table class="tb_normal" width=100%>
               ...
               <tr>
					...
					<td colspan="3"><html:hidden property="fdParentId" /> <html:text
						...
						onclick="Dialog_SimpleCategory('com.landray.kmss.km.imissive.model.KmImissiveSignRedHeadTemplate','fdParentId','fdParentName',false,null,'01',null,${selectEmpty},'${param.fdId}');null">
                ...
                <c:import url="/sys/authorization/sys_auth_area/sysAuthArea_field.jsp" charEncoding="UTF-8">
                    <c:param name="id" value="${kmImissiveSignRedHeadTemplate.authAreaId}"/>
                </c:import> 
				<tr>
					<td class="td_normal_title" width=15%><bean:message
				...
				<tr>
					<td width=100% colspan="2">
						...
						<c:import url="/sys/attachment/sys_att_main/jg/sysAttMain_edit.jsp" charEncoding="UTF-8">
							...
							<c:param name="fdAttType" value="${kmImissiveSignRedHeadTemplateForm.fdType}" />
