...
<template:include ref="default.list">
	...
	<template:replace name="path">
		<ui:menu layout="sys.ui.menu.nav"  id="categoryId"> 
		    ...
		    <ui:menu-item text="签报" href="/km/imissive/km_imissive_sign_main/index.jsp" target="_self">
	  ...
	  <list:criteria id="signCriteria">
			...
			<list:cri-ref ref="criterion.sys.category" key="fdTemplate" multi="false" title="分类导航" expand="true">
			  <list:varParams modelName="com.landray.kmss.km.imissive.model.KmImissiveSignTemplate"/>
				...
				<list:cri-criterion title="${ lfn:message('km-imissive:kmImissiveSignMain.Sign.my') }" key="mydoc" multi="false">
				<list:box-select>
					<list:item-select>
			...
			<list:cri-criterion title="${ lfn:message('km-imissive:kmImissiveSignMain.fdSigntoDept')}" key="SendtoUnit">
		      <list:box-select> 
		        <list:item-select type="lui/criteria/criterion_input!TextInput"> 
		        <ui:source type="Static">
		           [{placeholder:'${ lfn:message('km-imissive:kmImissiveSignMain.fdSendtoDept')}'}]
		        </ui:source>
		        </list:item-select>
		      </list:box-select>
		    </list:cri-criterion>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
					{url:'/km/imissive/km_imissive_sign_main/kmImissiveSignMain.do?method=listChildren&categoryId=${param.categoryId}'}
			</ui:source>
	 	...
	 	var SYS_SEARCH_MODEL_NAME ="com.landray.kmss.km.imissive.model.KmImissiveSignMain";
			...
			seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/toolbar'], function($, dialog , topic,toolbar) {
				...
				window.chgSelect = function() {
					...
					Com_OpenWindow('<c:url value="/km/imissive/km_imissive_sign_main/kmImissiveChangeTemplate.jsp" />?values='+values+'&categoryId=${param.categoryId}');
					return ;
				};
				//归档
	            ...
	            window.showFilingBtn = function(cateId,nodeType){
        			 var checkDelUrl ="/km/imissive/km_imissive_sign_main/kmImissiveSignMain.do?method=filingall";
					 var data = new Array();
