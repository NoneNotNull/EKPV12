...
<script>
	...
	function openReportWindow(){
		Dialog_Tree(false, 'fdReportSettingId', 'fdReportSettingName', ',', 'kmKeydataTreeService&parentId=!{value}&keydataType=supplier', '数据选择', null, function callbackFunc(rtnVal){loadConditionPage(rtnVal);}, '${param.fdId}', null, null, '数据选择');
	}
