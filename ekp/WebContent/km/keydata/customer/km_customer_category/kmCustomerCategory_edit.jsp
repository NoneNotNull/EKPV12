...
<table
		...
		<tr>
			...
			<td colspan="3"><html:hidden property="fdParentId" /> <html:text
				...
				onclick="Dialog_SimpleCategory('${param.fdModelName}','fdParentId','fdParentName',false,null,'01',null,false,'${param.fdId}');">
...
<script>
	...
	function openReportWindow(){
		Dialog_Tree(false, 'fdReportSettingId', 'fdReportSettingName', ',', 'kmCustomerMainTreeServiceImp&parentId=!{value}', '<bean:message key="dialog.tree.title" bundle="dbcenter-report-cfg"/>', null, function callbackFunc(rtnVal){loadConditionPage(rtnVal);}, '${param.fdId}', null, null, '<bean:message key="dialog.title" bundle="dbcenter-report-cfg"/>');
	}
