...
<template:include ref="mobile.list">
	...
	<template:replace name="head">
		...
		<link rel="Stylesheet" href="${LUI_ContextPath}/km/calendar/mobile/resource/css/group.css" />
		...
		<div class="muiCalendarContainer">
			<div id="calendar" class="muiCalendarListView"
				...
				<div data-dojo-type="mui/calendar/CalendarHeader"
					data-dojo-props="left:{href:'/km/calendar/mobile/index.jsp',icon:'mui-personIco'}"></div>
				...
				<div data-dojo-type="mui/calendar/CalendarBottom" data-dojo-props="url:''">
					...
					<div class="CalendarListView" data-dojo-type="mui/calendar/CalendarListScrollableView">
						<ul data-dojo-type="km/calendar/mobile/resource/js/GroupJsonStoreList"
							data-dojo-mixins="km/calendar/mobile/resource/js/list/GroupItemListMixin"
							data-dojo-props="url:'/km/calendar/km_calendar_main/kmCalendarMain.do?method=listGroupCalendar&loadAll=true&groupId=${groupId}&fdStart=!{fdStart}&fdEnd=!{fdEnd}'">
						</ul>
					</div>
				</div>
			</div>
