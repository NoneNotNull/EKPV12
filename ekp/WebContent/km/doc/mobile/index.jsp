...
<template:include ref="mobile.list">
	<template:replace name="head">
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/km/doc/mobile/resource/css/doc.css?v=1.0"></link>
	</template:replace>
	...
	<template:replace name="content">
		<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
			<div
				...
				data-dojo-props=" defaultUrl:'/km/doc/mobile/nav.jsp',modelName:'com.landray.kmss.km.doc.model.KmDocKnowledge' ">
			</div>
			<div
				data-dojo-type="mui/search/SearchButtonBar" 
				data-dojo-props="modelName:'com.landray.kmss.km.doc.model.KmDocKnowledge' ">
			</div>
		</div>
