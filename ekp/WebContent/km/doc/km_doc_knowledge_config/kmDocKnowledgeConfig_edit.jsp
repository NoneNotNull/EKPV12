...
<html:form action="/km/doc/km_doc_knowledge_config/kmDocKnowledgeConfig.do">
	<div id="optBarDiv">
		<input type=button value="<bean:message key="button.update"/>"
			onclick="submitForm('update');">
	</div>
	<p class="txttitle">
		<bean:message bundle="km-doc" key="kmDocTemplate.commonConfig"/>
	</p>
	<center>
		<table class="tb_normal" width="90%">
				<tr class="tr_normal_title">
					<td width="40%">
						<bean:message bundle="km-doc" key="kmDocTemplate.commonConfig.selectTree"/>
					</td>
					<td width="10%">&nbsp;</td>
					<td width="40%">
				...
				<tr>
					...
					<td>
						<center>
							<input type=button class="btnopt" value="<bean:message bundle="km-doc" key="kmDocTemplate.commonConfig.view"/>" onclick="openCategory();">
							<br><br>
					...
					<td>
						<center>
							<input type=button class="btnopt" value="<bean:message bundle="km-doc" key="kmDocTemplate.commonConfig.view"/>" onclick="openNav(document.getElementsByName('tmpSelectList')[0])">
							<br><br>
...
Com_IncludeFile("select.js|tree_page.js");
							...
							{
								LKSTree = new TreeView("LKSTree", "<bean:message bundle='km-doc' key='kmDocTemplate.commonConfig.selectCategory'/>", document.getElementById("treeDiv"));
							...
							function addNavs(){
								...
								if(selList == ""){
									alert('<bean:message bundle="km-doc" key="kmDocTemplate.commonConfig.selectCategory.notNull"/>');
									return;
								}
							...
							function openNav(obj){
								if(obj.selectedIndex==-1)
									return;
								Com_OpenWindow("<c:url value="/km/doc/km_doc_template/kmDocTemplate.do?method=view&fdId="/>"+obj.options[obj.selectedIndex].value, "_blank");
							}
							function openCategory(){
								...
								if(selList == "")
									...
									Com_OpenWindow("<c:url value="/km/doc/km_doc_template/kmDocTemplate.do?method=view&fdId="/>"+selList[0].value, "_blank");
							}
