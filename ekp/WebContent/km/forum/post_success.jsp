					...
					<div class="prompt_centerC">
						<div class="prompt_container clearfloat">
							...
							<div class="prompt_content_right">
								...
								<div class="links" style="font-size: 16px;text-align: left">
									<a href="<c:url value='/km/forum/indexCriteria.jsp' />" target="_self" style="font-size: 16px;color: #3E9ECE"/><bean:message bundle="km-forum" key="kmForumPost.postHrefTips" /></a>
								</div>
