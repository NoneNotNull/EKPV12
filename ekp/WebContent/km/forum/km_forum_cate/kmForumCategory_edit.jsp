...
<table class="tb_normal" width=95%>
	...
	<tr>
		...
		<td colspan=3>
			<html:hidden property="fdManagerIds" />
			<html:text property="fdManagerNames" readonly="true" styleClass="inputsgl" style="width:90%"/>
			<a href="#" onclick="Dialog_Address(true, 'fdManagerIds', 'fdManagerNames', ';', ORG_TYPE_PERSON);">
