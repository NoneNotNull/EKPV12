...
function saveAdd()
{
	 Com_Submit(document.tibSapSyncCategoryForm, 'saveadd');
}
</script>
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<html:text property="fdParentName" readonly="true"
				styleClass="inputsgl" style="width:34%" /> <a href="#" onclick="Dialog_Tree(false, 'fdParentId', 'fdParentName', ',', 'tibSapSyncCategoryTreeService&parentId=!{value}', 
