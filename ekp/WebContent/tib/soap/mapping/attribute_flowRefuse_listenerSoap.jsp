...
function getInfo(templateId, soapFuncValue) {
	var xmlUrl = XMLDATABEANURL+"tibCommonMappingFuncListService&fdType=3&fdInvokeType=6&fdTemplateId="+templateId;
	...
	/*var data = new KMSSData();
	data.SendToBean("tibCommonMappingFuncListService&fdType=3&fdInvokeType=6&fdTemplateId="+templateId,
	function(rtnData){
		setFuncOption(rtnData, soapFuncValue);
	});*/
}
