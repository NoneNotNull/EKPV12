...
function submitForm(type){
	...
	Com_Submit(document.tibSoapSyncJobForm, type);
}
...
<div id="optBarDiv">
	<c:if test="${tibSoapSyncJobForm.method_GET=='edit'}">
		<input type=button value="<bean:message key="button.update"/>"
		onclick="submitForm('update');">
	</c:if>
	<c:if test="${tibSoapSyncJobForm.method_GET=='add'}">
		<input type=button value="<bean:message key="button.save"/>"
			onclick="submitForm('save');">
		<input type=button value="<bean:message key="button.saveadd"/>"
			onclick="Com_Submit(document.tibSoapSyncJobForm, 'saveadd');">
	</c:if>
	<input type="button" value="<bean:message key="button.close"/>" onclick="Com_CloseWindow();">
</div>

<p class="txttitle">SOAP<bean:message bundle="tib-soap-sync" key="table.tibSoapSyncJob"/></p>
...
<table class="tb_normal" width=95% id="TB_MainTable">
	...
	<td class="td_normal_title" width=15%>
		...
		<html:hidden property="docCategoryId" /> <xform:text
		 ...
		 <a href="#" onclick="Dialog_Tree(false, 'docCategoryId', 'docCategoryName', ',', 'tibSoapSyncCategoryTreeService&parentId=!{value}', 
	...
	<tr>
		<td width=15% class="td_normal_title">
			...
			<c:import url="/sys/quartz/sys_quartz_job/sysQuartzJob_showCronExpression.jsp" charEncoding="UTF-8">
				<c:param name="value" value="${tibSoapSyncJobForm.fdTempCronExpression}" />
			</c:import>
		</td>
		<td width=15% class="td_normal_title">
			...
			<%
				CronExpression expression = new CronExpression(tibSoapSyncJobForm.getFdTempCronExpression());
	...
	<!-- =============================================== -->
<%@ include file="/tib/soap/sync/tib_soap_sync_job/tibSoapSync_tempEdit.jsp"%>	
		</table>
