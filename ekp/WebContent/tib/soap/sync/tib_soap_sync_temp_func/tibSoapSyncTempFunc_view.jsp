...
<p class="txttitle">SOAP 定时任务映射配置  <img src="${KMSS_Parameter_ContextPath}resource/style/default/tag/help.gif" title='帮助' style="cursor:pointer" onclick='Com_OpenWindow("tibSoapSyncSettingHelp.jsp","_blank")' ></img> </p>
