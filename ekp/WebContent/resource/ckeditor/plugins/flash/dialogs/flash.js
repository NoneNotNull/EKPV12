			...
			contents : [{
						...
						elements : [{
							...
							label : CKEDITOR.tools
									.htmlEncode(a.lang.flash.flashvars),
							children : [{
										type : "vbox",
										padding : 0,
										children : [{
...
function OnUploadCompleted(errorNumber, fdId, customMsg) {
...
function SetUrl(url, width, height, alt) {
	var dialog = CKEDITOR.dialog.getCurrent();
	dialog.setValueOf('info', 'width', width ? width : '');
	dialog.setValueOf('info', 'height', height ? height : '');
	dialog.setValueOf('info', 'src', url ? url : '');
