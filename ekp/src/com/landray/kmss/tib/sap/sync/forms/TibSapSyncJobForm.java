 ...
 */
public class TibSapSyncJobForm extends ExtendForm {
    ...
    public String getFdTempCronExpression()
  {
   ...
   public void setFdTempCronExpression(String fdTempCronExpression) {
	 ...
	 * 定时任务id的表单
	 */
	protected AutoArrayList fdSapInfoForms = new AutoArrayList(TibSapSyncTempFuncForm.class);
	
	/**
	 * @return 定时任务id的表单
	 */
	public AutoArrayList getFdSapInfoForms() {
		return fdSapInfoForms;
	}
	
	/**
	 * @param fdSapInfoForms 定时任务id的表单
	 */
	public void setFdSapInfoForms(AutoArrayList fdSapInfoForms) {
		this.fdSapInfoForms = fdSapInfoForms;
	}
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		fdSapInfoForms = new AutoArrayList(TibSapSyncTempFuncForm.class);
		
		super.reset(mapping, request);
	}

	public Class getModelClass() {
		return TibSapSyncJob.class;
	}
		...
		if (toModelPropertyMap == null) {
			...
			toModelPropertyMap.put("docCategoryId",
					new FormConvertor_IDToModel("docCategory",
						TibSapSyncCategory.class));
			toModelPropertyMap.put("fdSapInfoForms", new FormConvertor_FormListToModelList(
					"fdSapInfo", "fdQuartz"));
		}
