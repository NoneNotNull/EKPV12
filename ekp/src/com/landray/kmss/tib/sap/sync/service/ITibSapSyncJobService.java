 ...
 */
public interface ITibSapSyncJobService extends IBaseService {
	
	public void updateChgEnabled(String[] ids,boolean isEnable) throws Exception;
	
	/**
	 * 启用或禁用quartz,用来修改sap Quartz 的 启用状态
	 * 用来同步sys quartz
	 * @param ids sys quartz下的定时任务
	 * @param fenable
	 */
	public void updateEnableTibSapSync(String[] ids,Boolean fenable) throws Exception ;
	
	/**
	 * 通过ekp定时任务id查找sap定时任务Id
	 * @param ekpQuartzID
	 * @return 
	 */
