 ...
 */
public class TibSoapSyncJob extends BaseModel {
	 ...
	 * 所属分类
	 */
	protected TibSoapSyncCategory docCategory;
	
	/**
	 * @return 所属分类
	 */
	public TibSoapSyncCategory getDocCategory() {
		return docCategory;
	}
	 ...
	 */
	public void setDocCategory(TibSoapSyncCategory docCategory) {
	 ...
	 * 定时任务映射信息
	 */
	protected List<TibSoapSyncTempFunc> fdSoapInfo;
	
	/**
	 * @return 定时任务映射信息
	 */
	public List<TibSoapSyncTempFunc> getFdSoapInfo() {
		return fdSoapInfo;
	}
	 ...
	 */
	public void setFdSoapInfo(List<TibSoapSyncTempFunc> fdSoapInfo) {
		this.fdSoapInfo = fdSoapInfo;
	}
	
	public Class getFormClass() {
		return TibSoapSyncJobForm.class;
	}
