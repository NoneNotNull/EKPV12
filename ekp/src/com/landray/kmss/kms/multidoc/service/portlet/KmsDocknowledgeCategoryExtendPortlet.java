...
public class KmsDocknowledgeCategoryExtendPortlet implements IKmsDataBean {
		...
		if (StringUtil.isNull(fdTemplateId)) {
			...
			for (int i = 0; i < kmsMultidocTemplateList.size(); i++) {
				...
				String fdHref = requestInfo.getContextPath()
						+ "/kms/multidoc/kms_multidoc_knowledge/kmsMultidocKnowledge.do?method=index&stype=extend&filterType=template&templateId="
