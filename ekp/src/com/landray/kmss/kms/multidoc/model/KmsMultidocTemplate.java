 ...
 * @author 王晖 模板设置
 */
public class KmsMultidocTemplate extends SysSimpleCategoryAuthTmpModel implements
	...
	public Class getFormClass() {
		return KmsMultidocTemplateForm.class;
	}
	...
	private List<KmsMultidocKnowledge> knowledges;

	public List<KmsMultidocKnowledge> getKnowledges() {
		return knowledges;
	}

	public void setKnowledges(List<KmsMultidocKnowledge> knowledges) {
